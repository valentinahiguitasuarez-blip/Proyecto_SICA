...
<main class="admin-dashboard">
    <aside class="admin-sidebar" aria-label="Menu del administrador">
        <a class="admin-brand admin-brand--with-mark" href="<?= admin_s_h(app_url('admin/index.php')) ?>">
            <span>
                <strong>SICA</strong>
        ...
        <nav class="admin-nav">
            <a href="<?= admin_s_h(app_url('admin/index.php')) ?>"><span class="nav-symbol nav-symbol-dashboard" aria-hidden="true"></span>Panel de Control</a>
            <a href="<?= admin_s_h(app_url('admin/usuarios.php')) ?>"><span class="nav-symbol nav-symbol-users" aria-hidden="true"></span>Usuarios</a>
            <a class="active" href="<?= admin_s_h(app_url('admin/solicitudes.php')) ?>"><span class="nav-symbol nav-symbol-reservations" aria-hidden="true"></span>Solicitudes de Reserva</a>
            <a href="<?= admin_s_h(app_url('admin/correos.php')) ?>"><span class="nav-symbol nav-symbol-mail" aria-hidden="true"></span>Correos y Notificaciones</a>
            <a href="<?= admin_s_h(app_url('admin/auditorios.php')) ?>"><span class="nav-symbol nav-symbol-auditoriums" aria-hidden="true"></span>Auditorios</a>
            <a href="<?= admin_s_h(app_url('admin/reportes.php')) ?>"><span class="nav-symbol nav-symbol-reports" aria-hidden="true"></span>Reportes</a>
        </nav>
    </aside>
                ...
                <div class="admin-reservation-list">
                    <article class="admin-empty-state">
                        ...
                        <?php if ($search !== '' || $estadoFiltro !== '' || $auditorioFiltro > 0): ?>
                            <span>Ningún resultado con los filtros actuales.</span>
                            <a href="<?= admin_s_h(app_url('admin/solicitudes.php')) ?>">Limpiar filtros y ver todo</a>
                        <?php else: ?>
                            <span>Cuando los instructores separen auditorios, aparecerán aquí.</span>
                        <?php endif; ?>
                    </article>
                </div>
            <?php else: ?>
