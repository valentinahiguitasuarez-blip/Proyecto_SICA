...
<section class="dashboard-hero">
    <div class="dashboard-hero-copy">
        ...
        <h2>Gestiona auditorios, c?digos y asistencia con una vista m?s clara.</h2>
...
<section class="metric-grid" aria-label="Resumen del instructor">
    ...
    <article class="metric-tile amber"><span>Pendientes</span><strong><?= instructor_h($stats['pendientes']) ?></strong><small>En revisi?n administrativa</small><em>Seguimiento</em></article>
...
<section class="dashboard-grid">
    <article class="next-event-card">
        <div class="panel-head">
            <div>
                ...
                <h2><?= $eventoDestacado ? instructor_h($eventoDestacado['nombre_evento']) : 'Tu pr?ximo evento aparecer? aqu?' ?></h2>
            </div>
        ...
        <?php if ($eventoDestacado): ?>
            ...
            <div class="event-spotlight">
                ...
                <div class="event-detail-list">
                    ...
                    <div><span>C?digo</span><strong><?= instructor_h($eventoDestacado['codigo_evento']) ?></strong></div>
            ...
            <div class="hero-actions">
                ...
                <a class="secondary-btn" href="<?= instructor_h(app_url('instructor/asistencia.php?evento=' . (int)$eventoDestacado['id_evento'])) ?>">C?digo QR</a>
            </div>
        <?php else: ?>
            <div class="empty-state">Crea una solicitud desde disponibilidad para activar el seguimiento del evento, c?digo y participantes.</div>
    ...
    <aside class="quick-panel">
        <div class="panel-head">
            <div>
                <p class="eyebrow">Accesos r?pidos</p>
                <h2>Operaciones</h2>
            </div>
        </div>
        <div class="quick-actions">
            ...
            <a href="<?= instructor_h(app_url('instructor/asistencia.php')) ?>"><span>QR</span><strong>C?digos</strong><small>Ingreso al evento</small></a>
...
<section class="panel process-panel">
    ...
    <div class="process-grid">
        ...
        <article class="process-step"><b>2</b><strong>Env?a solicitud</strong><p>Registra fecha, hora, tipo y descripci?n.</p></article>
        <article class="process-step"><b>3</b><strong>Revisi?n</strong><p>Coordinaci?n aprueba o rechaza la solicitud.</p></article>
        <article class="process-step"><b>4</b><strong>Asistencia</strong><p>Usa el c?digo del evento y consulta participantes.</p></article>
    </div>
</section>
