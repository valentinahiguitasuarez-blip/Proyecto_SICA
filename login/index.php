        ...
        <div class="login-card">
            ...
            <form id="loginForm" action="validar_login.php" method="post" autocomplete="off" novalidate>
                ...
                <div class="login-field password-field"><span class="field-icon" aria-hidden="true">
                    ...
                    </span><input type="password" class="form-control" id="contrasena" name="contrasena" placeholder="Contrase&ntilde;a" required maxlength="72" autocomplete="new-password" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^A-Za-z0-9]).{6,72}" title="Debe incluir mayúscula, minúscula, número y carácter especial." readonly data-lpignore="true" data-1p-ignore="true" data-bwignore="true" data-form-type="other"><button type="button" class="password-eye" aria-label="Mostrar contrase&ntilde;a">
